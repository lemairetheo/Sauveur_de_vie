...
{:else}
    ...
    <div style="background-color:{couleur};" out:fly={{x:100, duration:800}} in:fly={{x:100, duration:800}} on:click={change_value} class="z-10 w-[20%] h-full top-0 right-0 fixed hidden md:flex md:flex-row align-middleb content-center items-center justify-center">
